...
// CreateArticle 创建文章,属于ArticleAPIService结构体的方法：函数接收上下文请求参数，返回文章对象或错误
func (s *ArticleAPIService) CreateArticle(
	ctx context.Context, req *pb.Article) (*pb.Article, error) {
	// 通过用户凭证
